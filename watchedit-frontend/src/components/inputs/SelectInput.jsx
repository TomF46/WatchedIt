        ...
        <div className="field">
            ...
            <div className="relative">
                <select
                    ...
                    value={value ? value : ''}
                    onChange={onChange}
                    className="block appearance-none w-full bg-backgroundOffset2 border border-gray-500 hover:border-gray-500 px-4 py-2 pr-8 leading-tight focus:outline-none focus:outline rounded"
                >
                    {defaultText && (
