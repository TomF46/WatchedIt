                ...
                <div className="mt-4">
                    ...
                    {trivia.length > 0 ? (
                        <>
                            ...
                            {total > totalItems && (
                                <Link to={`/films/${film.id}/trivia`} className="text-primary hover:opacity-75">View {total - totalItems} more</Link>
                            )}
                        </>
                    ) : (
                        <p className="text-lg">This film currently has no trivia. <Link to={`/films/${film.id}/trivia/add`} className="text-primary">Add some now.</Link></p>
                    )}
                </div>
            )}
        </div>
