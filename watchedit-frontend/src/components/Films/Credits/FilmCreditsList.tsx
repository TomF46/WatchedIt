...
const FilmCreditsList = ({ credits, canEdit, onRemove }: Props) => {
            ...
            <div className='my-1 grid grid-cols-24 rounded shadow'>
              ...
              >
                <div
                  ...
                  className='inline-flex h-full w-full cursor-pointer items-center bg-backgroundOffset p-2 hover:opacity-75'
                >
                  <p>
