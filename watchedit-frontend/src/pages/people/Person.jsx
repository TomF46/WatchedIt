                    ...
                    <div className="grid grid-cols-12 mt-4">
                        ...
                        <div className="col-span-12 mt-4 md:col-span-10 md:pl-4 md:mt-0">
                            <div className="grid grid-cols-12">
                                ...
                                <div className="col-span-12 md:col-span-2 md:ml-2 text-center bg-backgroundOffset p-4 shadow rounded">
                                    <h3 className="text-success text-xl mb-4">Likes</h3>
                                    <p className="text-success text-2xl">{person.likedByCount}</p>
