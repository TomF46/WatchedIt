    ...
    return (
        <div className="list-page">
            {!list ? (
                ...
                <div>
                    <h1 className="text-center text-primary text-4xl my-4 font-bold">{list.name}</h1>
                    {userCanEdit && (
                    ...
                    <div className="mt-4">
                        ...
                        {list.films.length > 0 ? (
                            ...
                            <div className="my-16">
                                ...
                                <p className="text-center text-2xl">{userCanEdit ? "You have not yet added a film to this list." : "The list owner has not added a film to this list."}</p>
                            </div>
                        )}
                    </div>
                </div>
