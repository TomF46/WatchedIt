...
import AddFilmCreditForm from "../../../components/People/Credits/AddFilmCreditForm";
                    ...
                    {!people ? (
                        ...
                        <div className="mt-4">
                            {!selectedPerson ? (
                                ...
                                <AddFilmCreditForm selectedPerson={selectedPerson}  onPersonDeselected={handlePersonSelected} onSave={handleSave} saving={saving} />
                            )}
                        </div>
                    )}
                </div>
