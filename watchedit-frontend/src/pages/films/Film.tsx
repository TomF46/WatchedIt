        ...
        <div className="col-span-12 mt-4 md:col-span-10 md:pl-4 md:mt-0">
          <div className="grid grid-cols-12">
            <div className="col-span-12 md:col-span-8 bg-backgroundOffset p-2 shadow rounded">
              ...
              <p>Name: {film.name}</p>
              <p>
                Release date: {format(parseISO(film.releaseDate), "dd/MM/yyyy")}
              </p>
            ...
            <div className="col-span-12 md:col-span-2 text-center bg-rating md:ml-4 mt-4 md:mt-0 p-4 shadow rounded">
              <h3 className="text-black font-semibold text-xl mb-4">Rating</h3>
              {film.averageRating ? (
                <div>
                  <p className="text-2xl text-black font-semibold">
                  ...
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-10 h-10 inline-flex text-black items-center mt-4"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
