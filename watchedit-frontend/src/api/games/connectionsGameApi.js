...
export function getConnectionsGames(pageNumber, pageSize) {
    return client
        .get(`/api/games/ConnectionsGame?PageNumber=${pageNumber}&PageSize=${pageSize}`)
        .then(response => {
...
export function startConnectionsGame(){
    return client.post(`/api/games/ConnectionsGame`,{})
        .then(response => {
            return response.data;
        })
        .catch(error => {
...
export function makeGuessForConnectionsGame(id, guess){
    return client.post(`/api/games/ConnectionsGame/${id}`, guess)
        .then(response => {
            return response.data;
        })
        .catch(error => {
