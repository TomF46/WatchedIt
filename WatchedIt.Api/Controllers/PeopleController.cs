...
namespace WatchedIt.Api.Controllers
{
    ...
    public class PeopleController : ControllerBase
    {
        ...
        [HttpGet("birthdays")]
        public async Task<ActionResult<PaginationResponse<GetPersonOverviewDto>>> GetByBirthday([FromQuery] PersonBirthdaySearchWithPaginationParameters parameters)
        {
            return Ok(await _personService.GetByBirthday(parameters));
        }
    }
}