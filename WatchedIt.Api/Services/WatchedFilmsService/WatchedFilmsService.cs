...
namespace WatchedIt.Api.Services.WatchedFilmsService
{
    public class WatchedFilmsService : IWatchedFilmsService
    {
        ...
        public async Task<bool> CurrentUserHasWatchedFilmWithId(int id, int userId)
        {
        ...
        public async Task<GetHasWatchedFilmDto> RemoveWatchedFilm(int id, int filmId)
        {
            ...
            if(film is null) throw new BadRequestException($"Film with Id '{filmId} does not exist");
