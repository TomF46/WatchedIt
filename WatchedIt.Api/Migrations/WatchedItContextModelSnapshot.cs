...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsArticleNewsCategory", b =>
                {
                    b.Property<int>("CategoriesId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CategoriesId", "NewsArticlesId");

                    b.HasIndex("NewsArticlesId");

                    b.ToTable("NewsArticleNewsCategory");
                });
            ...
            modelBuilder.Entity("WatchedIt.Api.Models.Files.PersonImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WatchedIt.Api.Models.NewsCategoryModels.NewsCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WatchedIt.Api.Models.TagModels.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmTag", b =>
                {
                    ...
                    b.HasOne("WatchedIt.Api.Models.TagModels.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NewsArticleNewsCategory", b =>
                {
                    b.HasOne("WatchedIt.Api.Models.NewsCategoryModels.NewsCategory", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WatchedIt.Api.Models.News.NewsArticle", null)
                        .WithMany()
