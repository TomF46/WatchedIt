...
namespace WatchedIt.Api.Data
{
    public class BulkDataSeeder
    {
        ...
        public BulkDataSeeder(WatchedItContext context, IHostEnvironment env, IConfiguration config, IAuthenticationService authenticationService)
        {
            _context = context;
            _env = env;
            _config = config;
        ...
        public void Seed()
        {
            ...
            if (_env.IsDevelopment())
            {
                ...
                var bulkUserSeeder = new BulkUserSeeder(_context, _config, _env, _authenticationService);
                bulkUserSeeder.Seed();
            }
